    ...
    <div className="min-h-screen bg-gray-50">
      ...
      >
        ...
        <div className="absolute bottom-0 left-0 right-0 p-4 border-t border-gray-200">
          <Link
            to="/profile"
            className="flex items-center space-x-3 mb-3 p-2 -m-2 rounded-lg hover:bg-gray-100 transition-colors"
            onClick={() => setSidebarOpen(false)}
          >
            ...
            <div className="flex-1 min-w-0">
              ...
              <p className="text-xs text-gray-500 truncate">{user?.email || user?.department}</p>
            </div>
          </Link>
          <button
